...
# Paths
input_directory = r"C:\xampp\htdocs\ThesisPrototype\CleanedOriginalDatasets\Acne"  # Replace with the path to your image datasets
output_directory = r"C:\xampp\htdocs\ThesisPrototype\Grayscaledatasets\Original\Acne"  # Replace with the path where you want to save grayscale images
