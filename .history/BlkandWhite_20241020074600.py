...
# Paths
input_directory = r"C:\xampp\htdocs\ThesisPrototype\CleanedOriginalDatasets\ChikenFox"  # Replace with the path to your image datasets
output_directory = r"C:\xampp\htdocs\ThesisPrototype\Grayscaledatasets\Original\ChikenFox"  # Replace with the path where you want to save grayscale images
