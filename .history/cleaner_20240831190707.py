...
def standardize_image_format(image_path, output_format='jpeg'):
    image = Image.open(image_path)
    image = image.convert('RGB')
    new_path = os.path.splitext(image_path)[0] + f'.{output_format}'
    image.save(new_path, 'JPEG')  # Corrected to 'JPEG'
    return new_path
...
# Run the script
input_directory = r'C:\Users\andre\Downloads\7Dataset-20240717T141942Z-001\Final Datasets\outputforchikenfox'
output_directory = r'C:\Users\andre\Downloads\7Dataset-20240717T141942Z-001\CleanedDatasets\chikenfox'
