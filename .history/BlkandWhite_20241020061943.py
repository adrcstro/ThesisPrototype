...
# Paths
input_directory = r"C:\xampp\htdocs\ThesisPrototype\CleanedDatasets\Acne"  # Replace with the path to your image datasets
output_directory = r"C:\xampp\htdocs\ThesisPrototype\Grayscaledatasets\Original"  # Replace with the path where you want to save grayscale images
